	...
	return (
		<section>
			<section className="lg:flex lg:justify-between lg:items-center">
				...
				<article className="flex flex-col justify-center items-center my-10 lg:w-1/2">
					...
					<Link
						to="/catalogue"
						className="px-4 md:px-6 py-1.5 md:py-3 md:text-3xl lg:text-2xl bg-black text-white rounded-full mt-6 cursor-pointer hover:opacity-80">
						Découvrir
					</Link>
				</article>
			</section>
